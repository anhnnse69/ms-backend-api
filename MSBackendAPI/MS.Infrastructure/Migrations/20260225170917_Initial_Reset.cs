    ...
    public partial class Initial_Reset : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), "123 Đường Lớn, Hà Nội", "Hà Nội", "system", new DateTimeOffset(new DateTime(2026, 2, 25, 17, 9, 16, 909, DateTimeKind.Unspecified).AddTicks(8279), new TimeSpan(0, 0, 0, 0, 0)), "The largest general hospital in the region", "Bệnh viện đa khoa lớn nhất khu vực", "contact@centralhospital.vn", true, "system", null, "/assets/images/facilities/central_hospital.png", "Central Hospital", "Bệnh viện Trung ương", "0987654321", 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("44444444-4444-4444-4444-444444444444"), "456 Đường Nhỏ, Hà Nội", "/assets/images/patients/nguyenvana.png", "system", new DateTimeOffset(new DateTime(2026, 2, 25, 17, 9, 16, 909, DateTimeKind.Unspecified).AddTicks(8431), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Nguyễn Văn A", "nguyenvana@example.com", "Nguyễn Văn A", 0, "123456789", "987654321", "system", null, "0901234567" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), "system", new DateTimeOffset(new DateTime(2026, 2, 25, 17, 9, 16, 909, DateTimeKind.Unspecified).AddTicks(7899), new TimeSpan(0, 0, 0, 0, 0)), "General internal medicine specialty", "Chuyên khoa nội tổng quát", 1, "/assets/images/specialties/internal_medicine.png", true, "system", null, "General Internal Medicine", "Nội tổng quát" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("55555555-5555-5555-5555-555555555555"), "/assets/images/users/admin.png", "system", new DateTimeOffset(new DateTime(2026, 2, 25, 17, 9, 16, 909, DateTimeKind.Unspecified).AddTicks(8483), new TimeSpan(0, 0, 0, 0, 0)), "Admin User", "admin@example.com", null, "Administrator", true, null, "system", null, "hashed_password", "0999999999", 1, "admin" });

            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "Id", "AcademicTitleEn", "AcademicTitleVi", "AvatarUrl", "AverageRating", "BioEn", "BioVi", "CreateBy", "CreateDate", "DisplayName", "Email", "FullName", "IsActive", "LastModifiedBy", "LastModifiedDate", "PhoneNumber", "PhotoUrl", "RatingCount", "SpecialtyId", "YearsOfExperience" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "PhD", "Tiến sĩ", "/assets/images/doctors/john_doe.png", 4.7999999999999998, "Internal medicine specialist", "Bác sĩ chuyên khoa nội", "system", new DateTimeOffset(new DateTime(2026, 2, 25, 17, 9, 16, 909, DateTimeKind.Unspecified).AddTicks(8339), new TimeSpan(0, 0, 0, 0, 0)), "Dr. John Doe", "john.doe@example.com", "John Doe", true, "system", null, "0123456789", "/assets/images/doctors/john_doe.png", 120, new Guid("22222222-2222-2222-2222-222222222222"), 15 });
